            ...
            <div className='row g-0 vh-100 justify-content-center align-items-center mt-2 '>
                <div className='col-10 row g-0 align-items-center border rounded-2'>
                    <div className='col-6' >
                        ...
                        <img src={require('../images/102.avif')} alt="computer-logo" className='img-1' />
                    </div>
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className='form-floating mb-3'>
                            <input type='text' className='form-control' value={username} id='username' placeholder='name@example.com' onChange={(e) => { setUsername(e.target.value) }} />
