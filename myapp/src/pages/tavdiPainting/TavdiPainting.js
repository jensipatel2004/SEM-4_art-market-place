...
import './tavdiPainting.css'; // Ensure to create a CSS file for styles
import { Link } from 'react-router-dom';

function TavdiPainting() {
  return (
    <div>
...
<ul className="nav justify-content-center" style={{ backgroundColor: 'rgb(209, 153, 153)' }}>
      ...
      <div className="container">
        {[
          { src: '82.jpg', title: 'Dot art', price: '₹95,000' },
          { src: '83.jpg', title: 'Flower', price: '₹67,000' },
          { src: '84.jpg', title: 'Sparow', price: '₹30,000' },
          { src: '85.jpg', title: 'Houses with birds', price: '₹75,000' },
          { src: '86.jpg', title: 'Swirl Tree', price: '₹98,000' },
          { src: '87.jpg', title: 'Cow', price: '₹40,000' },
          { src: '88.jpg', title: 'Peacock', price: '₹28,000' },
          { src: '89.jpg', title: 'Nature', price: '₹35,000' },
          { src: '90.jpg', title: 'Buddha', price: '₹60,900' },
          { src: '91.jpg', title: 'African dance', price: '₹88,000' },
          { src: '92.webp', title: 'Madhubani', price: '₹94,809' },
          { src: '93.webp', title: 'Hanging pot', price: '₹60,000' },
        ].map((art, index) => (
          <div className={`card card-${index + 1}`} key={index}>
            ...
            <div className="card-body">
              <h2 className="card-local">Tavdi Painting</h2>
